//
//  BqProfileTableViewController.m
//  Bq 微博
//
...
@interface BqProfileTableViewController ()

@end

@implementation BqProfileTableViewController
...
//    self.navigationItem.titleView = vc.view;
    ...
    BqLog(@"BqProfileTableViewController-viewDidLoad");
}
